...
List itemsTab = [
  {"icon": const Icon(Icons.home), "iconSize": 28.0},
  {"icon": const Icon(FontAwesomeIcons.locationDot), "iconSize": 22.0},
  {"icon": const Icon(FontAwesomeIcons.userLarge), "iconSize": 21.0},
  {"icon": const Icon(FontAwesomeIcons.bagShopping), "iconSize": 22.0},
  {"icon": const Icon(Icons.more_horiz), "iconSize": 40.0},
];
